(function (global) {
    ...
    global.app.DrawNode.RockSnakeNode = (function () {
        ...
        RockSnakeNode.prototype.draw = function (ctx) {
            ...
            ctx.beginPath();
            ctx.moveTo(radius, 0);
            ctx.lineTo(radius * (5 / 6), radius * (3 / 6));
            ctx.lineTo(radius * (4 / 6), radius * (5 / 6));
            ctx.lineTo(radius * (2 / 6), radius);
            ctx.lineTo(radius * -(1 / 6), radius * (9 / 6));
            ctx.lineTo(0, radius * (5 / 6));
            ctx.lineTo(radius * -(1 / 6), radius * (2 / 6));
            ctx.lineTo(radius * -(4 / 6), 0);
            ctx.lineTo(radius * -(1 / 6), radius * -(2 / 6));
            ctx.lineTo(0, radius * -(5 / 6));
            ctx.lineTo(radius * -(1 / 6), radius * -(9 / 6));
            ctx.lineTo(radius * (2 / 6), radius * -1);
            ctx.lineTo(radius * (4 / 6), radius * -(5 / 6));
            ctx.lineTo(radius * (5 / 6), radius * -(3 / 6));
            ctx.lineTo(radius, 0);
            ctx.fill();
